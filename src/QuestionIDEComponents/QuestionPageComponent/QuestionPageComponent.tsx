...
import Navbar from "../../StudentUser/Navbar/Navbar";
...
const QuestionPageComponent: React.FC = () => {
  ...
  const questionsData: Question[] = [
    ...
    },
    {
      ...
      output: "[1,2,3]",
      difficulty: "Easy",
      testcases: [{ input: "[1,1,2,3,3]", output: "[1,2,3]" }],
      constraints: { time: "O(n)", space: "O(1)" },
      tags: "Linked List",
    },
    {
      ...
      <div>
        {clickedQuestion ? (
          <div style={{marginTop:'64px'}}>
            <button onClick={handleBackClick}>Back to Questions</button>
            <QuestionIDEComponent question={clickedQuestion} />
          </div>
        ) : (
